...
impl Scalar {
    ...
    pub fn negate(&self) -> Self {
        Self(U256::from_words(crate::zisk::fn_negate(&self.0.to_words())))
    }
    ...
    pub fn add(&self, rhs: &Self) -> Self {
        Self(U256::from_words(crate::zisk::fn_add(&self.0.to_words(), &rhs.0.to_words())))
    }
    ...
    pub fn sub(&self, rhs: &Self) -> Self {
        Self(U256::from_words(crate::zisk::fn_sub(&self.0.to_words(), &rhs.0.to_words())))
    }
    ...
    #[cfg(all(target_os = "zkvm", target_vendor = "zisk"))]
    pub fn mul(&self, rhs: &Scalar) -> Scalar {
        Self(U256::from_words(crate::zisk::fn_mul(&self.0.to_words(), &rhs.0.to_words())))
    }
