...
## [1.9.0-surge](https://github.com/NethermindEth/raiko/compare/v1.8.0-surge...v1.9.0-surge) (2025-08-29)


### Features

* chain_spec_list_default.json updated ([49603c5](https://github.com/NethermindEth/raiko/commit/49603c59613b56a33d214fe2f0afab5f7e161652))
* cicd surge tag tracking ([#32](https://github.com/NethermindEth/raiko/issues/32)) ([8ecd1a5](https://github.com/NethermindEth/raiko/commit/8ecd1a5104ac62f51a5510abdb6eb8f4dfb4f5aa))
* image ids endpoint update ([#16](https://github.com/NethermindEth/raiko/issues/16)) ([761e2c6](https://github.com/NethermindEth/raiko/commit/761e2c69346c570a080e8fe2acf64ff81f53ba6f))
...
* **raiko:** update cicd workflow ([446d123](https://github.com/NethermindEth/raiko/commit/446d1239ad986e8908180c966d67bba8a40aeb64))
* **raiko:** update cicd workflow for raiko images ([52bc26c](https://github.com/NethermindEth/raiko/commit/52bc26cbb99e9d2d6b4faad6e30c1e54d483b011))
* **raiko:** update the sgx build ([e5adbd8](https://github.com/NethermindEth/raiko/commit/e5adbd858b380d307705b46db8ea030a0071604a))
* remove verification of chain_spec_list ([77b7968](https://github.com/NethermindEth/raiko/commit/77b796839ba0d317c18383d3252c879ddb7dda65))
...
* **surge:** update cicd workflow for raiko images ([282d752](https://github.com/NethermindEth/raiko/commit/282d75297557db2c2ed7f6d9dc5654aa2ecebad1))
...
* **taiko:** update workflow_dispatch repo ([08c5144](https://github.com/NethermindEth/raiko/commit/08c51446a3574f5d14942703d13d18cfb450ec51))
* **taiko:** update workflow_dispatch repo ([52c25d5](https://github.com/NethermindEth/raiko/commit/52c25d51682ea60af0053a69e766cb50b1adc0b2))
* **taiko:** update workflow_dispatch repo ([10a3fe1](https://github.com/NethermindEth/raiko/commit/10a3fe183f4c8e86618383772ec11cff99413829))
* **taiko:** update workflow_dispatch repo ([67f4ee5](https://github.com/NethermindEth/raiko/commit/67f4ee5e1d471876c6863f50f168d59bddae040d))
...
* cicd pipeline sgx and sp1 ([1e4d50a](https://github.com/NethermindEth/raiko/commit/1e4d50a23f7264e89b25a4b312311b307420cab7))
* cicd pipeline sgx and sp1 ([2037f3e](https://github.com/NethermindEth/raiko/commit/2037f3e8c37e2ef286b1a5de0421e1bc37de2658))
* cicd pipeline sgx and sp1 ([f073f23](https://github.com/NethermindEth/raiko/commit/f073f234d38d126481469dd2fb6355e97197357a))
* docker compose for zk ([0bdaa86](https://github.com/NethermindEth/raiko/commit/0bdaa86015880e2ad628d8a989cd342d31890221))
* env SP1_VERIFIER_ADDRESS expect fix ([49960ac](https://github.com/NethermindEth/raiko/commit/49960ac145b6b9e716a051c01f3d157e0f44b016))
* **raiko:** entrypoint for zk machines ([3066e9b](https://github.com/NethermindEth/raiko/commit/3066e9b4357a13f9fecbb2332b49d4f4a386006d))
