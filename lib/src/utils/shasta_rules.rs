...
const MAX_BLOCK_GAS_LIMIT: u64 = 45_000_000 + ANCHOR_V3_V4_GAS_LIMIT;
const MIN_BLOCK_GAS_LIMIT: u64 = 10_000_000 + ANCHOR_V3_V4_GAS_LIMIT;
...
pub fn validate_shasta_block_gas_limit(
    ...
    for manifest_block in manifest_blocks.iter() {
        let block_gas_limit: u64 = manifest_block.gas_limit + ANCHOR_V3_V4_GAS_LIMIT;
