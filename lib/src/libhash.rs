...
fn pack_derivation_fields(derivation: &Derivation) -> B256 {
    ...
    let origin_block_number_bytes = derivation.originBlockNumber.to_be_bytes_vec();
    packed[0..6].copy_from_slice(&origin_block_number_bytes);
...
mod test {
    ...
    fn test_hash_proposal() {
        let proposal = Proposal {
            id: 3549.try_into().unwrap(),
            timestamp: 1761830468.try_into().unwrap(),
            endOfSubmissionWindowTimestamp: 0.try_into().unwrap(),
    ...
    fn test_shasta_transition_hash() {
        ...
        let transition = ShastaTransition {
            ...
            checkpoint: Checkpoint {
                blockNumber: 1512.try_into().unwrap(),
                blockHash: b256!(
    ...
    fn test_hash_transitions_array_fixed_values() {
        ...
        let transitions = vec![
            ...
            ShastaTransition {
                ...
                checkpoint: Checkpoint {
                    blockNumber: 1000.try_into().unwrap(),
                    blockHash: b256!(
            ...
            ShastaTransition {
                ...
                checkpoint: Checkpoint {
                    blockNumber: 2000.try_into().unwrap(),
                    blockHash: b256!(
            ...
            ShastaTransition {
                ...
                checkpoint: Checkpoint {
                    blockNumber: 3000.try_into().unwrap(),
                    blockHash: b256!(
    ...
    fn test_pack_derivation_fields() {
        let derivation = Derivation {
            originBlockNumber: 155.try_into().unwrap(),
        ...
        let derivation = Derivation {
            ...
            sources: vec![DerivationSource {
                ...
                blobSlice: BlobSlice {
                    ...
                    timestamp: 1758948572.try_into().unwrap(),
                },
            }],
        };
